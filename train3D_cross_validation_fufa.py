...
def main():
    ...
    for dataset in range(1,6):
        ...
        t = t
        # 存放每一折的训练数据
        log_path = '/home/shujingyuan/logs/M3D_ResNet/cross_validation/fufa/lr_decrease/{}_{}'.format(t,dataset)
        ...
        for tg in range(10):
            ...
            print(tg)
            train_dataset = RGB_images_3D_cut_yf_ff(image_path,split='train',data_spilt=dataset,paths=[0,1,2],cross_validation=True,test_group=tg, is_yuanfa = False)
            valid_dataset = RGB_images_3D_cut_yf_ff(image_path,split='valid',data_spilt=dataset,paths=[0,1,2],cross_validation=True,test_group=tg, is_yuanfa = False)
            ...
            save_path = '/home/shujingyuan/pths/M3D_ResNet/cross_validation/fufa/lr_decrease/{}_1/M3D_ResNet_{}.pth'.format(dataset, tg)
            save_dir = '/home/shujingyuan/pths/M3D_ResNet/cross_validation/fufa/lr_decrease/{}_1'.format(dataset)
