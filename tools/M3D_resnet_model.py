...
class M3D_ResNet(nn.Module):
    ...
    def __init__(self,
                 ...
                 no_cuda = False,
                 include_top=True):
        super(M3D_ResNet, self).__init__()
        self.inplanes = 64
...
class ResNet_3d_with_DA(nn.Module):
    ...
    def __init__(self,
                 ...
                 no_cuda = False,
                 include_top=True):
        super(ResNet_3d_with_DA, self).__init__()
        self.inplanes = 64
        self.no_cuda = no_cuda
        self.include_top = include_top
